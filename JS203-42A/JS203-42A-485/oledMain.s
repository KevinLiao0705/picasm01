...
T4I_2:				;;
	...
	;;;;;;;;;;;;;;;;;;;;;;;;;;
	MOV #10,W0		;;
	BTSC MCUU4_MODE,#0	;;PARITY L
	BRA T4I_ODD		;;
	BTSC MCUU4_MODE,#1	;;PARITY L
	BRA T4I_EVEN		;;
T4I_NONE:			;;
	CP MCURX4_BIT		;;
	BRA LTU,T4I_END		;;
...
;0x00113E~1B 	  : RESERVE 
;0x00113F~1B 	  : B76:SERIAL_CHANNEL,B54:OUTPUT MODE,B30:OUTPUT PORT   
;0x001140~3B 	  : rx code address(l2h) of switch to page 4, real must x4 
;0x001143~3B 	  : rx code address(l2h) of switch to page 5, real must x4 
;0x001146~3B 	  : rx code address(l2h) of switch to page 6, real must x4 
;0x001149~3B 	  : rx code address(l2h) of switch to page 7, real must x4 
;0x00114C~3B 	  : rx code address(l2h) of switch to page 8, real must x4 
;0x00114F~1B 	  : RESERVE 
;0x001150~3B 	  : image address(l2h) of page 4, real must x4 
;0x001153~3B 	  : image address(l2h) of page 5, real must x4 
;0x001156~3B 	  : image address(l2h) of page 6, real must x4 
;0x001159~3B 	  : image address(l2h) of page 7, real must x4 
;0x00115C~3B 	  : image address(l2h) of page 8, real must x4 
;0x00115F~1B 	  : RESERVE 
