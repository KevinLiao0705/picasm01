...
SETCMD1_J2:
	call CLR_LCDBUF
	LOXY 0,0	
	LOFFS1 hardPowerOnStr		;;
	CALL ENSTR
	bra SETCMD1_JX
SETCMD1_J3:
	call CLR_LCDBUF
	LOXY 0,0	
	LOFFS1 hardPowerOffStr		;;
	CALL ENSTR
	bra SETCMD1_JX
SETCMD1_JX:
	CP0 DISPLAY_MOD
...
softResetStr:
	.ascii "ACT 1: SOFT RESET \0"
hardResetStr:
	.ascii "ACT 3: HARDWARE RESET \0"
hardPowerOnStr:
	.ascii "ACT 4: HARDWARE POWER ON \0"
hardPowerOffStr:
	.ascii "ACT 4: HARDWARE POWER OFF \0"
